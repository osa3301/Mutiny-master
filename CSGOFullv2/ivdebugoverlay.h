...
public:
	...
	virtual void            ClearDeadOverlays(void) = 0; //index 16
	...
	virtual void            DrawPill(const Vector& mins, const Vector& max, float& diameter, int r, int g, int b, int a, float duration, int unknown, int occlude) = 0;
private:
